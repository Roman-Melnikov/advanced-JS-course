Vue.component('products', {
    ...
    template:
            `<div class="products-wrp products-wrp-catalog">
    ...
    template:
        `<a href="#" class="products-item">
            <div class="products-item-wrp-blackout">
              <img class="products-item-photo" :src="img + product.image" alt="catalog-product" height="420" width="360">
            </div>
            <span class="products-item-title">{{product.product_name}}</span>
            <p class="products-item-txt">{{product.txt}}
            </p>
            <span class="products-item-price">{{product.price}} &#8381;</span>
            <div class="products-btn-wrap">
                <button class="products-item-btn" @click="cartAPI.addProduct(product)">
